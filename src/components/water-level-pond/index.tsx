...
export const EWaterLevelPond = withInstall(defineComponent({
    ...
    setup(props) {
        const { height, width, fontSize, decimals, fontColor, backgroundColor, waveColors } = props;
        ...
        const start = () => {
            animation(props.duration, startVal.value, props.value, (value) => {
                // 通过tranalate改变定位
                waterDom.value.style.transform = `translate(0, ${100 - value}%)`;
        ...
        return () => (
            <>
                ...
                <BoxContainer height={height} width={width} fontSize={fontSize} fontColor={fontColor} backgroundColor={backgroundColor} waveColors={waveColors}>
                    <div class="percent">
